...
public class MainConfiguration {
    ...
    @Bean
    public PublicationNotifier publicationNotifier(@Value("${ua.koliambus.service.catalog.song.sqs-queue}") String queueName) {
    ...
    public RestHighLevelClient elasticsearchClient(
            @Value("${ua.koliambus.catalog.elasticsearch.host}") String host,
            @Value("${ua.koliambus.catalog.elasticsearch.port}") Integer port,
            @Value("${ua.koliambus.catalog.elasticsearch.scheme}") String scheme
    ) {
